...
| Cited search extraction | Convert Google Custom Search snippets and readable page text into market and preparation signals without another LLM call. |
...
- Deep agentic research review is still planned; current research uses manual notes, local query plans, optional Google Custom Search snippets, readable-page extraction, and deterministic synthesis.
