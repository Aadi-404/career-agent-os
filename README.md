...
- Score-only prompt split: mandatory matching asks only for scoring evidence and empty optional artifacts; preparation and coaching are generated by separate endpoints.
