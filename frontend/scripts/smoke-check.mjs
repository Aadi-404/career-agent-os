...
const checks = [
  ...
  },
  {
    ...
    file: "src/main.tsx",
    patterns: ["Resume Rewrite", "Build Rewrite Suggestions", "Evidence-Constrained Rewrite", "Apply to Resume Draft", "Accepted Rewrite History", "Resume Version Snapshots", "accepted-resume-rewrites", "resume-versions", "gap_do_not_claim"],
  },
  {
