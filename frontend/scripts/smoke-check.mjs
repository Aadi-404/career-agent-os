...
const checks = [
  ...
  },
  {
    ...
    file: "src/main.tsx",
    patterns: ["Resume Rewrite", "Build Rewrite Suggestions", "Evidence-Constrained Rewrite", "Apply to Resume Draft", "Accepted Rewrite History", "accepted-resume-rewrites", "gap_do_not_claim"],
  },
  {
